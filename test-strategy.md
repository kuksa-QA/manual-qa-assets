...
## 1. Project Overview
Automation Exercise is a demo e-commerce web application that allows users to browse products (including search), register accounts, manage carts, complete purchases.
